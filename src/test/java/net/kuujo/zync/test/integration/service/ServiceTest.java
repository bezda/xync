 ...
 */
package net.kuujo.zync.test.integration.service;
...
import net.kuujo.zync.cluster.impl.DefaultZyncClusterClient;
import net.kuujo.zync.test.integration.ZyncTestVerticle;
 ...
 */
public class ServiceTest extends ZyncTestVerticle {

  @Test
  public void testDeployModule() {
    final ZyncClusterClient client = new DefaultZyncClusterClient(vertx.eventBus());
    client.deployModule("test1", "net.kuujo~zync-test1~1.0", new Handler<AsyncResult<String>>() {
      @Override
  ...
  public void testDeployModuleToGroup() {
    final ZyncClusterClient client = new DefaultZyncClusterClient(vertx.eventBus());
    client.deployModuleTo("test1", "__DEFAULT__", "net.kuujo~zync-test1~1.0", new JsonObject(), 1, new Handler<AsyncResult<String>>() {
      @Override
      public void handle(AsyncResult<String> result) {
        assertTrue(result.succeeded());
        assertEquals("test1", result.result());
