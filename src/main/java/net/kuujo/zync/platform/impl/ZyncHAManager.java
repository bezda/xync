 ...
 */
public class ZyncHAManager extends HAManager {

  private static final Logger log = LoggerFactory.getLogger(ZyncHAManager.class);
  ...
  public ZyncHAManager(VertxInternal vertx, PlatformManagerInternal platformManager, ClusterManager clusterManager, int quorumSize, String group) {
    ...
    clusterManager.nodeListener(new NodeListener() {
      ...
      public void nodeAdded(String nodeID) {
        ZyncHAManager.this.nodeAdded(nodeID);
      }

      @Override
      public void nodeLeft(String leftNodeID) {
        ZyncHAManager.this.nodeLeft(leftNodeID);
      }
    });
